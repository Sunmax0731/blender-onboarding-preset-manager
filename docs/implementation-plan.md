...
1. 要件定義、仕様、設計を NON PICKUP Rank 13 と ZIP metadata から再構成。
...
6. `dist/blender-onboarding-preset-manager-docs.zip` を生成。

## 次フェーズ

- 実ユーザーの手動テスト結果を反映する。
- Blender アドオン導入前に使える CLI と Blender Python host adapter を実データで拡張する。
