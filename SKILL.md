...
blender-onboarding-preset-manager の作業手順です。
...
- asset は `dist/blender-onboarding-preset-manager-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md`。
